  ...
  apps: [
    {
      ...
      script: './broker/index.js', // 启动 js 脚本
      port: '1883', // 启动端口
      ...
      ignore_watch: ['.DS_Store', 'logs', 'pm2-logs'], // 忽略监控的文件夹

      // 4.日志
      time: true, // 是否为日志添加日期前缀
      log_date_format: 'YYYY-MM-DD HH:mm:ss', // 日志时间格式
      out_file: './pm2-logs/pm2-access.log', // 正常日志位置
      error_file: './pm2-logs/pm2-error.log', // 异常日志位置
    ...
    },
    {
      ...
      script: './broker/index-websocket.js', // 启动 js 脚本
      port: '8083', // 启动端口
      env: { NODE_ENV: 'production' }, // 环境变量
